...
#################################################################
class my_variables():
    def __init__(self, task_path, size_data=[98, 120, 120], cuda=False, batch_size=15, workers=6, epochs=1000, lr=0.0001, nesterov=True, weight_decay=0.005, momentum=0.5):
        self.cuda = cuda
...
def get_annotations(xml_path, data_folder, list_of_strokes=None):
    ...
    for xml_file in xml_list:
        ...
        video_path = os.path.join("../data/videos", xml_file.split('/')[-1].split('.')[0])
...
def make_work_tree(main_folder, source_folder, frame_width=320, extract=True):
    print("main_foler: ",main_folder)
    ...
    print("detection_folder: ",detection_path)
...
def classification_task(main_folder, data_path, task_path):
    ...
    # Model variables
    args = my_variables('../data/classificationTask')
...
def detection_task(main_folder, data_path, task_path):
    ...
    # Model variables
    args = my_variables('../data/detectionTask')
...
if __name__ == "__main__":
    ...
    print(main_folder,'######',data_path, detection_path, classification_path)
    #Tasks
